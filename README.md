...
- `kubevirt_kmp_duplicate_macs`
  ...
  A MAC conflict occur in the following scenarios:
  - Multiple VMs use the same MAC address
  - VM with multiple interfaces, where multiple interfaces use the same MAC address. 
