...
while [[ $# -gt 0 ]]; do
    ...
    --help)
        ...
        echo "Options:"
        echo "--operator-name=VALUE     Specify the operator name"
        echo "--sub-operator-name=VALUE Specify the sub-operator name"
...
errors=$($OCI_BIN run -i "quay.io/kubevirt/prom-metrics-linter:$linter_image_tag" \
