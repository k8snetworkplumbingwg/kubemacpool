...
func NewPoolManager(kubeClient client.Client, cachedKubeClient client.Client, rangeStart, rangeEnd net.HardwareAddr, managerNamespace string, kubevirtExist bool, waitTime int) (*PoolManager, error) {
...
func (p *PoolManager) InitMaps() error {
	log.Info("foo-partial-client: Start InitMaps")
	err := p.initPodMap()
	if err != nil {
		return err
	}
	...
	log.Info("foo-partial-client: End InitMaps")
	return nil
}
